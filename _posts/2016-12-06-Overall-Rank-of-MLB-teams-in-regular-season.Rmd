---
title: "Overall ranking of MLB teams in regular season (Wild Card Era)"
output: 
 md_document:
...
```{r loading_pckg, message=FALSE, warning=FALSE}
# Loading packages
library(Lahman)
library(dplyr)
library(ggplot2)
...
```{r ranking_sparklines, warning = FALSE, fig.height=5, fig.width=8}
...
```{r ranking_histo, warning = FALSE, fig.height=5, fig.width=8}
