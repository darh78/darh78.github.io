...
```{r including_2016, include=FALSE}
...
```{r WS_champs_br_1, echo=FALSE, fig.height=5, fig.width=8}
...
```{r WS_champs_br_2, echo=FALSE, fig.height=5, fig.width=8}
...
```{r WS_champs_br_3, echo=FALSE, fig.height=2, fig.width=8}
Best_Champs <- within(Best_Champs,
...
```{r WS_champs_br_4, echo=FALSE, fig.height=5, fig.width=8}
...
```{r WS_champs_br_5, fig.height=5, fig.width=8}
...
```{r WC_Era_results, fig.height=5, fig.width=8}
